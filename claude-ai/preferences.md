...
Anthropic's support article on personalisation lists three layers: profile instructions, project
instructions, and styles. It says of profile instructions that they apply to all of your
conversations. It does not say whether a custom style can be made the default for new chats, so
this field is the safer home. If you find that styles can be defaulted, the same text works there.

For Cowork, this field may not be enough. Cowork loads the skills enabled for your claude.ai
account, and the documentation does not say whether it reads this field. `claude-ai/build.py`
packages the same text below as a skill in `claude-ai/plain-precise/`, which Cowork does read.
